    ...
    public partial class EE1 : Migration
    {
        ...
        protected override void Up(MigrationBuilder migrationBuilder)
        {
            ...
            migrationBuilder.InsertData(
                ...
                values: new object[,]
                {
                    { 1, "Седан", "Toyota", "Бензин", 45000, "Corolla", "AA1234AA", 20, "Доступна", 2, 2020 },
                    { 2, "Універсал", "Volkswagen", "Дизель", 62000, "Passat", "BB5678BB", 60, "Доступна", 2, 2019 },
                    { 3, "Седан", "Tesla", "Електро", 15000, "Model 3", "CC9012CC", 40, "Доступна", 2, 2022 }
                });
